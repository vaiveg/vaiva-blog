    ...
    <body>
        <div class="container">
			...
			<ul class="nav navbar-nav">
			    <li><a href="/posts"><i class="fa fa-btn fa-posts"></i>Posts</a></li>
			    <li><a href="/categories"><i class="fa fa-btn fa-categories"></i>Categories</a></li>
			    @if (Auth::check())
				<li><a href="/users"><i class="fa fa-btn fa-users"></i>Users</a></li>
			    @endif
			</ul>
